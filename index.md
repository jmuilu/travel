...
(function initMap() {
  ...
  var locations = [
    ...
    { name: "Hofkirche", coords: [47.2689, 11.3956], desc: "Keisari Maximilian I:n hautakirkko.", link: "itävalta/Innsbruck.html" },
    ...
    { name: "Schmittenhöhe", coords: [47.329, 12.738], desc: "Näköalavuori Zell am Seen yllä.", link: "itävalta/Zell_am_See.html" },
